...
function FPDF($orientation='P',$unit='mm',$format='A4')
{
	...
	if (is_string($format))
	{
		$format=Toolbox::strtolower($format);
		if ($format=='a3')
	...
	//Page orientation
	$orientation=Toolbox::strtolower($orientation);
...
function AddFont($family,$style='',$file='')
{
	...
	$family=Toolbox::strtolower($family);
	if ($file=='')
		$file=str_replace(' ','',$family).Toolbox::strtolower($style).'.php';
	if ($family=='arial')
		$family='helvetica';
	$style=Toolbox::strtoupper($style);
	if ($style=='IB')
		$style='BI';
