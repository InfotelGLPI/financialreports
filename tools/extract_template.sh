...
xgettext *.php */*.php --copyright-holder='Financialreports Development Team' --package-name='GLPI - Financialreports plugin' --package-version='2.0.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
